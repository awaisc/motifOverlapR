  ...
  dashboardBody(tabsetPanel(
    ...
    tabPanel("Computational Prediction Componment", 
             box(title = "motifOverlapR Inputs",   
               ...
               box(title = "Visualize the Position Weight Matrix", collapsible = TRUE, width= 8,
             ...
             box(title = "The Enhancer Predicted Sites", width = 12, collapsible = TRUE,
    ...
    tabPanel("Genome Browser and Data Table",
             box(title= "Genome Browser Inputs", 
                 ...
                 width = 3),
             box( title = "Genome Browser", width = 9, collapsible = TRUE, height = 600,
             withSpinner(plotOutput("GenomeBrowser"),
                         type = getOption("spinner.type", default = 3),
                         color = getOption("spinner.color", default = "#0275D8"),
                         color.background = getOption("spinner.color.background", default = "#FFFFFF"))),
             
             box( title = "Table showing the motifs in the genome browser", collapsible = TRUE, width = 7,
             withSpinner(dataTableOutput("DataTablePredictedSites"),
                         type = getOption("spinner.type", default = 3),
                         color = getOption("spinner.color", default = "#0275D8"),
                         color.background = getOption("spinner.color.background", default = "#FFFFFF"))),
             
             box(title = "Legend for the Chromatin State Track", collapsible = TRUE, width=5,
    ...
    tabPanel("Gene Ontology",
             box(actionButton("GeneOntology", "Compute Gene Ontology Results"), width= 3),
