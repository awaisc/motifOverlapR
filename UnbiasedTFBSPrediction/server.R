...
########## Bon Fonerani P Value Adjustment
  ...
  GeneTable <- filter(GeneOntologyResultsSorted,
                      `Number of DE Genes In Term` >= input$GeneOntologyNumeric &
           `Ontology Type` %in% input$OntologyType &
             `Adjusted P Value (FDR)` <= input$GeneOntologyPValueCutOff & 
             `P Value` <= input$GeneOntologyRawPvalue
         )
  GeneTable
